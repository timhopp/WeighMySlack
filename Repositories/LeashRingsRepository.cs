...
namespace weighmyslack.Repositories
{
  ...
  public class LeashRingsRepository
  {
    ...
    {
      string sql = @"INSERT INTO LeashRings (manufacturerid, name, img, manufacturer, material, weight, wll, mbs, materialdiameter, innerdiameter, outerdiameter, price) VALUES (@manufacturerid, @name, @img, @manufacturer, @material, @weight, @wll, @mbs, @materialdiameter, @innerdiameter, @outerdiameter, @price); SELECT LAST_INSERT_ID();";
